function [hFigure] = STPlotDefConstant(stDef)

% STPlotDefConstant - FUNCTION [Internal] Plot a constant spike train definition
% $Id: STPlotDefConstant.m 2411 2005-11-07 16:48:24Z dylan $
%
% This function is NOT for command line use

% Usage: <[hFigure]> = STPlotDefConstant(stDef)
%
% 'stDef' is a definition node for a constant spike train.  A plot will be
% made showing the definition profile.
%
...
if (nargin < 1)
   disp('*** STPlotDefConstant: Incorrect usage');
   help private/STPlotDefConstant;
   return;
end
...
strTitle = sprintf('Constant frequency spike train definition\nSpike frequency profile');
title(strTitle);
